const Top3 = () => {
    return (
      <header className="self-stretch h-[90px] bg-white shadow-[0px_4px_12px_rgba(0,_0,_0,_0.16)] flex flex-row items-start justify-between pt-[11px] pb-2.5 pr-[35px] pl-0 box-border sticky top-[0] z-[99] max-w-full gap-[20px] text-left text-6xl text-darkslategray-400 font-secondary-text">
        ...
        <div className="w-[719px] flex flex-col items-start justify-start pt-2.5 px-0 pb-0 box-border max-w-full text-right text-base text-gray-800">
          <div className="self-stretch flex flex-row items-start justify-start gap-[45px] max-w-full mq750:gap-[45px_22px]">
            <div className="h-11 flex-1 flex flex-row items-start justify-start gap-[41px] max-w-full mq750:gap-[41px_20px]">
            ...
            <div className="w-[175px] flex flex-row items-start justify-start gap-[7px]">
        ...
        <div className="absolute !m-[0] bottom-[28px] left-[91px] text-xl font-semibold font-manrope text-gray-700 whitespace-nowrap z-[2]">
