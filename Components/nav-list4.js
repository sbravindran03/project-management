...
const NavList4 = () => {
  ...
  return (
    <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-0 gap-[14.635799407958984px] text-left text-mini-6 text-slategray-200 font-poppins">
      <div className="self-stretch rounded-[3.66px] bg-white flex flex-row items-center justify-start py-0 pr-[7px] pl-[7.299999999999955px]">
        <div className="flex flex-row items-center justify-center">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.299999999999955px] px-[7px] pb-[7.300000000000182px] box-border">
            <input
              className="accent-white1 m-0 h-[29.3px] w-[29.3px] relative overflow-hidden shrink-0"
              checked={editSquareIconChecked}
              type="checkbox"
              onChange={(event) =>
                setEditSquareIconChecked(event.target.checked)
              }
            />
          </div>
          <div className="flex flex-row items-center justify-center pt-[7.400000000000091px] px-[7.299999999999955px] pb-[7.199999999999818px]">
      ...
      <div className="w-[253.4px] rounded-[3.66px] bg-white flex flex-row items-center justify-start py-0 pr-[7px] pl-[7.299999999999955px] box-border text-xs-9 text-gray-400">
        <div className="w-[100.5px] flex flex-row items-center justify-center">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.400000000000091px] px-[7px] pb-[7.2000000000000455px] box-border">
            <img
          ...
          <input
            className="w-[calc(100%_-_29.3px)] [border:none] [outline:none] bg-[transparent] h-[36.6px] flex-1 flex flex-row items-center justify-center p-[7.299999999999955px] box-border font-poppins text-mini-6 text-slategray-200 min-w-[34px]"
            placeholder="Tasks"
            type="text"
          />
        </div>
      ...
      <div className="w-[253.4px] rounded-[3.66px] flex flex-row items-center justify-start py-0 pr-[7px] pl-[7.299999999999955px] box-border">
        <div className="flex flex-row items-center justify-center">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.300000000000182px] px-[7px] pb-[7.299999999999955px] box-border">
            <img
              className="h-[29.3px] w-[29.3px] relative overflow-hidden shrink-0"
              loading="lazy"
              alt=""
          ...
          <div className="flex flex-row items-center justify-center p-[7.299999999999955px]">
      ...
      <button className="cursor-pointer [border:none] py-0 pr-[7.300000000000182px] pl-[7.299999999999955px] bg-white w-[253.4px] rounded-[3.66px] flex flex-row items-center justify-between box-border gap-[20px]">
        <div className="flex flex-row items-center justify-center">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.300000000000182px] px-[7px] pb-[7.299999999999955px] box-border">
            <img
              className="h-[29.3px] w-[29.3px] relative overflow-hidden shrink-0"
          ...
          <div className="flex flex-row items-center justify-center p-[7.299999999999955px]">
            <div className="relative text-mini-6 tracking-[0.01em] leading-[22px] font-poppins text-slategray-200 text-left inline-block min-w-[97px]">
              Performance
            </div>
          </div>
        </div>
        <div className="h-[22px] w-[22px] flex flex-row items-start justify-start">
          <div className="hidden flex-row items-start justify-start">
            <div className="h-[22px] w-[22px] relative rounded-[3.66px] bg-aliceblue-200 overflow-hidden shrink-0">
              <div className="absolute top-[-1.8px] left-[8.2px] text-xs-9 leading-[26.53px] font-poppins text-gray-400 text-left">
                1
              </div>
            </div>
          </div>
