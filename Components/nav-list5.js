    ...
    <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-0 gap-[14.635799407958984px] text-left text-mini-6 text-slategray-200 font-poppins">
      <div className="self-stretch rounded-[3.66px] bg-white flex flex-row items-center justify-start py-0 pr-[7px] pl-[7.299999999999955px]">
        <div className="flex flex-row items-center justify-center py-0 px-0">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.299999999999955px] px-[7px] pb-[7.300000000000068px] box-border">
            <input
      ...
      <div className="w-[253.4px] rounded-[3.66px] bg-aliceblue-100 flex flex-row items-center justify-start py-0 pr-[7px] pl-[7.299999999999955px] box-border text-xs-9 text-gray-400">
        <div className="w-[100.5px] flex flex-row items-center justify-center py-0 px-0 box-border">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.399999999999977px] px-[7px] pb-[7.2000000000000455px] box-border">
            <img
          ...
          <input
            className="w-[calc(100%_-_29.299999999999887px)] [border:none] [outline:none] bg-[transparent] h-[36.6px] flex-1 flex flex-row items-center justify-center p-[7.299999999999955px] box-border font-poppins text-mini-6 text-slategray-200 min-w-[34px]"
            placeholder="Tasks"
            type="text"
          />
        </div>
      ...
      <div className="w-[253.4px] rounded-[3.66px] flex flex-row items-center justify-start py-0 pr-[7px] pl-[7.299999999999955px] box-border">
        <div className="flex flex-row items-center justify-center py-0 px-0">
          ...
          <div className="flex flex-row items-center justify-center py-[7.299999999999955px] px-[7px]">
      ...
      <div className="w-[253.4px] rounded-[3.66px] flex flex-row items-center justify-between py-0 px-[7.299999999999955px] box-border gap-[20px]">
        <div className="flex flex-row items-center justify-center py-0 px-0">
          <div className="h-[43.9px] flex flex-row items-center justify-center pt-[7.300000000000182px] px-[7px] pb-[7.299999999999955px] box-border">
            <img
              className="h-[29.3px] w-[29.3px] relative overflow-hidden shrink-0"
